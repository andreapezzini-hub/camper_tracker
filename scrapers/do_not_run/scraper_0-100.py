...
def run_scraper(db_conn, config, ollama_config=None):
    ...
    try:
        ...
        while urls_to_scan and count_elaborati < MAX_ANNUNCI:
            ...
            # Paginazione WooCommerce /page/2/
            for a in soup.find_all('a', href=True):
                href = a['href']
                if '/page/' in href and BASE_URL in href and href not in scanned_targets and href not in urls_to_scan:
            ...
            for link in soup.find_all('a', href=True):
                ...
                if '/prodotto/' not in path_lower: continue
                ...
                try:
                    ...
                    img_url = None
                    img = det_soup.find('img', class_=re.compile(r'wp-post-image'))
